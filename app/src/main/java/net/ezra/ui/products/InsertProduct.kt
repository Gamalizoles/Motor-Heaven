            ...
            LazyColumn(
                ...
                item {
                    ...
                    TextField(
                        ...
                        label = { Text("Listing Name",color = Color.White) },
                    ...
                    TextField(
                        ...
                        label = { Text("Unit Cost", color = Color.White) },
                    ...
                    if (productDescriptionError) {
                        Text("About is required", color = Color.Red)
                    }
                    if (productPriceError) {
                        Text("Cost is required", color = Color.Red)
                    }
