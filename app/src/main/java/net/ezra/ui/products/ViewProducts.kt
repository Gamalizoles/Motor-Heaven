        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                colors = TopAppBarDefaults.topAppBarColors(
                    containerColor = Color(0xff57435e),
            ...
            Column(
                ...
                if (isLoading) {
                    ...
                    Box(
                        ...
                        Text(text = "Looking for cars... ", fontSize = 20.sp,
                            color = Color.White
                        )
                    }
                } else {
                    if (productList.isEmpty()) {
                        // No products found
                        Text(text = "No listings found. check in later ")
                    } else {
                        // Products list
                        ...
                        if (displayedProductCount < productList.size) {
                            Button(
                                colors = ButtonDefaults.buttonColors(backgroundColor = Color(0xff57435e)),
                                onClick = { displayedProductCount += 1 },
                                modifier = Modifier.align(Alignment.CenterHorizontally)
                            ) {
                                Text(text = "More Listings")
                            }
                        }
                    }
                }
